...
type
  Tf_situation_a3_1 = class(TForm)
    ...
    q_reimp: TSQLQuery;
    q_mdm: TSQLQuery;
    procedure befor_print_qr(Sender: TCustomQuickRep; var PrintReport: Boolean);
    procedure befor_print_band2(Sender: TQRCustomBand; var PrintBand: Boolean);
    procedure befor_print_band4(Sender: TQRCustomBand; var PrintBand: Boolean);
    procedure befor_print_band5(Sender: TQRCustomBand; var PrintBand: Boolean);
    procedure befor_print_bande3(Sender: TQRCustomBand; var PrintBand: Boolean);
  private
...
var
  f_situation_a3_1: Tf_situation_a3_1;s,s1:string;
   tca,tca1,tca2,tem,tem1,tep,tep1,mdrt,mdrt1,mdrt2,REIMP,REIMP1,REIMP2,REIMP_ant:real;
   mto,mto1,mto2:real;
...
procedure Tf_situation_a3_1.befor_print_band4(Sender: TQRCustomBand;
...
begin
        ...
        // depenses annulees antérieures
           ...
           //strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           q_annul_ant.open;
         ...
         //  annul2_ant:=annul2_ant+annul_ant;
           ...
           q_annul_mois.Params[3].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate(f_etats.xdate.text,FormatSettings1);
           q_annul_mois.Params[4].Asdatetime:=strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate('01/'+copy(f_etats.xdate.text,4,7),FormatSettings1);
           q_annul_mois.open;
        ...
        // MANDATS ANTERIEURS
          ...
          // REIMPUTATIONS ANTERIEURES
                ...
                q_reimp_ant.Params[3].Asdatetime:=strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
                //strtodate('01/'+copy(f_etats.xdate.text,4,7),FormatSettings1);
           ...
           q_mda.Params[3].Asdatetime:=strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate('01/'+copy(f_etats.xdate.text,4,7),FormatSettings1);
           q_mda.open;
        ...
        //   q_mdms.Params[3].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
        //   q_mdms.Params[4].Asdatetime:=strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           q_mdms.open;
         ...
         REIMP:=0.0; q_reimp_du_mois.close;
           ...
           q_reimp_du_mois.Params[3].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate(f_etats.xdate.text,FormatSettings1);
           q_reimp_du_mois.Params[4].Asdatetime:=strtodate('01/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate('01/'+copy(f_etats.xdate.text,4,7),FormatSettings1);
           ...
           // les mandats pAr structure ////////////
                 // MANDATS 1° colonne  (antérieures et du mois)
                 // REIMPUTATION 1° colonne (antérieures et du mois)
                    tcax:=0.0;
                    q_REIMP.close;
                    ...
                    q_reimp.Params[4].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
                    //strtodate(f_etats.xdate.text,FormatSettings1);
                    q_reimp.open;
                    if  q_reimp.Fields[0].asstring<>'' then tcax:=q_reimp.Fields[0].value;

                    // mandats annulées 1° colonne
                    ...
                    q_annul_mois_ant_structure.Params[4].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
                    //strtodate(f_etats.xdate.text,FormatSettings1);
           ...
           q_mdm.Params[4].Asdatetime:=strtodate(copy(f_etats.xdate.text,1,2)+'/'+copy(f_etats.xdate.text,4,2)+'/'+copy(f_etats.xdate.text,7,4),FormatSettings1);
           //strtodate(f_etats.xdate.text,FormatSettings1);
           q_mdm.open;
...
procedure Tf_situation_a3_1.befor_print_band5(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     s:='            ';
        ...
        mdrt2:=0.0; annul2:=0.0;
end;

procedure Tf_situation_a3_1.befor_print_bande3(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
      s:='               ';
...
procedure Tf_situation_a3_1.befor_print_band2(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
      qrlabel15.Caption:=trim(f_dm.ClientDataSet_adm.FieldByName('LIBELLE_structure_situation').AsString);
end;

procedure Tf_situation_a3_1.befor_print_qr(Sender: TCustomQuickRep;
