unit u_situation_credits_article_tw;
...
type
  Tf_situation_credit_tw = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
...
var
   f_situation_credit_tw: Tf_situation_credit_tw;
   s,s1:string;
...
procedure Tf_situation_credit_tw.LIGNE(Sender: TQRCustomBand;
...
procedure Tf_situation_credit_tw.total(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        s:='            ';
...
procedure Tf_situation_credit_tw.totalg(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        s:='            ';
...
procedure Tf_situation_credit_tw.initier(Sender: TCustomQuickRep;
