object f_situation_credit_tw: Tf_situation_credit_tw
  Left = -9
  Top = 107
  ...
  object q_mda: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'where gestion=:x and chapitre=:y and article=:z and dates<:w'
        ...
        'and (structure='#39'1'#39' or structure='#39'2'#39' or structure='#39'3'#39' or structur' +
        'e='#39'4'#39' or structure='#39'5'#39' or structure='#39'6'#39')')
    SQLConnection = f_dm.connect_db_gf
    Left = 360
    Top = 400
  end
