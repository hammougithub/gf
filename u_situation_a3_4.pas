...
type
  Tf_situation_a3_4 = class(TForm)
    ...
    procedure befor_print_band3(Sender: TQRCustomBand; var PrintBand: Boolean);
...
procedure Tf_situation_a3_4.befor_print_band2(Sender: TQRCustomBand;
...
begin
   ...
   qrlabel19.Caption:=trim(f_dm.ClientDataSet_adm.FieldByName('LIBELLE_structure_situation').AsString);

   qrlabel1.Caption:='                ';
   if f_dm.ClientDataSet_adm.locate('structure_situation',vararrayof([3]),[]) then
   qrlabel1.Caption:=trim(f_dm.ClientDataSet_adm.FieldByName('LIBELLE_structure_situation').AsString);

   qrlabel24.Caption:='                ';
   if f_dm.ClientDataSet_adm.locate('structure_situation',vararrayof([4]),[]) then
   qrlabel24.Caption:=trim(f_dm.ClientDataSet_adm.FieldByName('LIBELLE_structure_situation').AsString);


end;

procedure Tf_situation_a3_4.befor_print_band3(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        s:='            ';
        ...
        m471:=0.0;mdrt1:=0.0;m031:=0.0;m301:=0.0;
end;

procedure Tf_situation_a3_4.befor_print_band4(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
    tca:=0;
        s:='            '; q_cre_affec.close;
...
procedure Tf_situation_a3_4.befor_print_band5(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
              s:='            ';
        ...
        m472:=0.0;mdrt2:=0.0;m032:=0.0;m302:=0.0; annul2:=0.0;


end;

procedure Tf_situation_a3_4.befor_print_qr(Sender: TCustomQuickRep;
