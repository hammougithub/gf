...
procedure Tf_situation_a3_3.BEFOR_PRINT_BAND2(Sender: TQRCustomBand;
...
procedure Tf_situation_a3_3.befor_print_band4(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
    tca:=0;
        s:='            '; q_cre_affec.close;
...
procedure Tf_situation_a3_3.befor_print_qr(Sender: TCustomQuickRep;
...
procedure Tf_situation_a3_3.total(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
    s:='            ';
        ...
        m471:=0.0;mdrt1:=0.0;m031:=0.0;
end;

procedure Tf_situation_a3_3.totalg(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        ...
        m472:=0.0;mdrt2:=0.0;m032:=0.0; annul2:=0.0;
