unit u_situation_credits_article;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  QuickRpt, ExtCtrls, Qrctrls, Db, IBX.IBSQL ;

type
  Tf_situation_credit = class(TForm)
    QuickRep1: TQuickRep;
    QRBand1: TQRBand;
    QRLabel1: TQRLabel;
    QRLabel2: TQRLabel;
...
var
   f_situation_credit: Tf_situation_credit;
   s,s1:string;
...
procedure Tf_situation_credit.LIGNE(Sender: TQRCustomBand;
...
procedure Tf_situation_credit.total(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        s:='            ';
...
procedure Tf_situation_credit.totalg(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
        s:='            ';
...
procedure Tf_situation_credit.initier(Sender: TCustomQuickRep;
