...
begin
    ...
    if (s[1] in ['2','3','4','5','6','7','8','9']) and (s[2]<>'0') then x:=' æ '+x;
    ...
    if s[1]='1' then begin
     ...
     if (s[1] in ['1','2','3','4','5','6','7','8','9']) or (s[2] in ['1','2','3','4','5','6','7','8','9']) then x:=x+' ãáíæä ';
     ...
     if ((s[4] in ['1','2','3','4','5','6','7','8','9']) or (s[5] in ['1','2','3','4','5','6','7','8','9'])) and (s[3] in ['1','2','3','4','5','6','7','8','9']) then x:=x+' æ ';
     ...
     if (s[5] in ['1','2','3','4','5','6','7','8','9']) and (length(x1)>0) then x1:=' æ '+x1;
     ...
     if s[4]<>'1' then begin
                 ...
                 if (s[5]='1') and (s[4] in ['2','3','4','5','6','7','8','9']) then x:=x+'æÇÍÏ' +X1;
                 end;
     ...
     if (s[3] in ['1','2','3','4','5','6','7','8','9']) or (s[4] in ['1','2','3','4','5','6','7','8','9'])  or (s[5] in ['1','2','3','4','5','6','7','8','9']) then x:=x+' Çáİ ';
     ...
     x1:='';
     if (length(x)>0) and ((s[8] in  ['1','2','3','4','5','6','7','8','9']) or (s[7] in  ['1','2','3','4','5','6','7','8','9']) or (s[6] in  ['1','2','3','4','5','6','7','8','9'])) then x:=x+' æ '  ;
     ...
     if ((s[8] in ['1','2','3','4','5','6','7','8','9']) or (s[7] in ['1','2','3','4','5','6','7','8','9'])) and (s[6] in ['1','2','3','4','5','6','7','8','9']) then x:=x+' æ ';
     ...
     if (s[8] in ['1','2','3','4','5','6','7','8','9']) and (length(x1)>0) then x1:=' æ '+x1;
