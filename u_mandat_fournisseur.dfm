object f_mandat_fournisseur: Tf_mandat_fournisseur
  Left = 137
  Top = 51
  Caption = 'Liste de mandats d'#39'un fournisseur'
  ClientHeight = 736
  ClientWidth = 1219
  Color = clTeal
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 591
    Color = clSkyBlue
    DataSource = f_dm.DataSource_fournisseur1
  ...
  object SQL_lignes: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select structure,mandat,ligne,chapitre,article,dates,montant,obs' +
        'ervation from lignes'
      
        ' where gestion=:g and benificiaire=:a order by structure, mandat' +
        ',ligne ')
