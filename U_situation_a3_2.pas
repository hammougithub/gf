...
procedure Tf_situation_a3_2.befor_print_band2(Sender: TQRCustomBand;
...
procedure Tf_situation_a3_2.befor_print_band3(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
          s:='            ';
...
procedure Tf_situation_a3_2.befor_print_band4(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
       tca:=0;
        s:='            '; q_cre_affec.close;
...
procedure Tf_situation_a3_2.befor_print_band5(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
          s:='            ';
        ...
        m472:=0.0;mdrt2:=0.0; annul2:=0.0;

end;

procedure Tf_situation_a3_2.befor_print_qr(Sender: TCustomQuickRep;
