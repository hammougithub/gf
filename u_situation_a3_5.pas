...
var
  f_situation_a3_5: Tf_situation_a3_5; s,s1:string;
   tca,tca1,tca2,tem,tem1,tep,tep1,mdrt,mdrt1,mdrt2,m47,m471,m472,REIMP,REIMP1,REIMP2,REIMP_ant:real;
   mto,mto1,mto2,m03,m031,m032,m30,m301,m302,m11,m111,m112:real;
...
procedure Tf_situation_a3_5.befor_print_band4(Sender: TQRCustomBand;
...
begin
        ...
        // MANDATS ANTERIEURS
         ...
         // MANDATS 3 colonne
           ...
           // toutes mandats annulées 5 colonne
                    q_annul_mois_ant_structure.close;
                    q_annul_mois_ant_structure.Params[0].Asstring:=f_dm.clientdataset_chapitre.fieldByName('chapitre').asstring;
                    q_annul_mois_ant_structure.Params[1].Asstring:=f_dm.clientdataset_chapitre.fieldByName('article').asstring;
...
procedure Tf_situation_a3_5.befor_print_band2(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
     qrlabel27.Caption:='                ';
...
procedure Tf_situation_a3_5.befor_print_band3(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
              s:='            ';
...
procedure Tf_situation_a3_5.befor_print_qr(Sender: TCustomQuickRep;
...
procedure Tf_situation_a3_5.totalg(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
           s:='            ';
        if tca1<>0.0 then  s:=formater_float(tca1);
