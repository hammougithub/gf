object f_eng_four: Tf_eng_four
  ...
  object DBGrid1: TDBGrid
    ...
    Height = 592
    Color = clSkyBlue
    DataSource = f_dm.DataSource_fournisseur2
  ...
  object SQL_lignes: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select structure,fiche,ligne,objet,chapitre,article,dates,montan' +
        't  from det_eng where gestion=:g and benificiaire=:a order '
      'by structure,fiche,ligne ')
