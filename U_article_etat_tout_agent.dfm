object f_article_etat_tout_agent: Tf_article_etat_tout_agent
  Left = 0
  Top = 0
  Caption = 'f_article_etat_tout_agent'
  ClientHeight = 694
  ClientWidth = 1267
  Color = clSilver
  ...
  object lignes: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select a.ref,a.dates,a.qt,c.noma,b.adm,b.mat,b.noma,b.prenoma,a.' +
        'observation,a.service,a.adm,a.mat,a.designation,b.adm,b.mat,c.co' +
        'de,c.noma'
      'from consommation a,employes b,service c'
      
        'where ref=:x and a.service=c.code and a.adm=b.adm and a.mat=b.ma' +
        't'
      'order by a.adm,a.mat')
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.LastChange = 44410.466806527800000000
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object Memo36: TfrxMemoView
          ...
          Top = 263.266110000000000000
          Width = 61.922820000000000000
        ...
        object frxDBDataset1DESIGNATION: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
      ...
      object GroupHeader1: TfrxGroupHeader
        ...
        object Memo8: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[Trim(<group."noma_1">)+'#39'  '#39'+Trim(<group."prenoma">)+'#39'     '#39'+Tri' +
              'm(<group."noma">)]')
          ParentFont = False
          VAlign = vaCenter
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        object groupDATES: TfrxMemoView
          IndexTag = 1
          AllowVectorExport = True
  ...
  object custommer1: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select a.adm,a.mat,a.nom,a.prenom,a.noma,a.prenoma from employes' +
        ' a'
      
        'where exists (select b.mat,b.adm,b.ref from consommation b  wher' +
        'e ref=:x and (a.adm=b.adm and a.mat=b.mat))'
      '  order by a.adm,a.mat')
    SQLConnection = f_dm.connect_db_gf
    Left = 1112
    Top = 145
  ...
  object Cl3: TClientDataSet
    Aggregates = <>
    DisableStringTrim = True
    IndexFieldNames = 'ADM;MAT'
    MasterFields = 'ADM;MAT'
